...
class MainWindow(QMainWindow):
    ...
    def text_to_pdf(text, filename): #CONVERTIR A PDF https://stackoverflow.com/questions/10112244/convert-plain-text-to-pdf-in-python
        a4_width_mm = 210
        pt_to_mm = 0.35
        fontsize_pt = 10
    ...
    def saveToFile(self):
        ...
        file_name, _ = QFileDialog.getSaveFileName(self, "Save File",
            "","HTML Files (*.html);;Text Files (*.txt);;PDF Files (*.PDF)")
        ...
        if file_name.endswith(".txt"):
            ...
            notepad_richtext = self.text_edit.toPlainText()
            with open(file_name, "w") as f:            
                f.write(notepad_richtext)
